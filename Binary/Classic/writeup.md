...
We need to develop a decrypting algorithm for this. First 6 characters of the key a1 can be found using the flag format p_ctf. The other characters are found by reversing the encrypted key and find the difference between the two encrypted keys by encrypting the 6 characters separately. The decryption algorithm will be-
